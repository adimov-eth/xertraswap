import { ChainId, JSBI, Percent, Token, WETH } from '@xertra/sdk'
import { getCurrentContracts } from '../config/chains'

export const ROUTER_ADDRESS = getCurrentContracts().ROUTER
...
export const USDCbsc = new Token(ChainId.MAINNET, '0xaa0e34A393dadAAF661132deA1EDD834c5628e16', 18, 'USDC', 'USD Coin')
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [...WETH_ONLY[ChainId.MAINNET], USDT, USDC, USDCbsc],
}
